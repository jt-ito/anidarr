...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class UnicodeReleaseParserFixture : CoreTest
    {
        ...
        [TestCase("[H-Enc] おじさんで埋める穴 THE ANIMATION / Ojisan de Umeru Ana The Animation 01-02 (WEBRip 1080p HEVC AAC)", "Ojisan de Umeru Ana The Animation", "H-Enc", new[] { 1, 2 })]
        [TestCase("[SakuraCircle] Ojisan de Umeru Ana The Animation - 01-02 (おじさんで埋める穴 THE ANIMATION) (WEBRip 1080p)", "Ojisan de Umeru Ana The Animation", "SakuraCircle", new[] { 1, 2 })]
